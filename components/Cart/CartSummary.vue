  ...
  <div class="px-3 mt-10 lg:w-1/4 lg:pr-20 xs:w-full">
    ...
    <div class="right-0 border-b border-dotted 4/5 lg:mb-0">
      <div>
        ...
        <div class="flex justify-between mt-1">
          ...
          <div class="w-1/2 text-right ms-2 text-black-400">
        ...
        >
          ...
          <div
            ...
            class="w-1/2 text-right ms-2 text-black-400"
          >
            {{ $store.state.settings.shipping.charge | currency }}
          </div>
          <div v-else class="w-1/2 text-right ms-2 text-black-400">FREE</div>
        </div>
        <div class="mt-1">
      ...
      <div class="p-2 my-2 text-xs text-gray-500 rounded bg-accent-100">
        <div class="flex items-center">
          <img v-lazy="'/shield.png'" class="w-12 pr-2" alt="" />
    ...
    >
      <div class="flex justify-between mt-2">
        ...
        <div class="w-1/2 font-bold text-right ms-2 text-black-400">
          {{ cart.total | currency }}
        </div>
      </div>
