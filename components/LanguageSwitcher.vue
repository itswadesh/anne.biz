<template>
  <div class="hidden px-1 py-1 bg-gray-200 rounded md:flex">
    <nuxt-link :to="switchLocalePath('hi')">
      <div
    ...
    <nuxt-link :to="switchLocalePath('he')">
      <div
        class="flex px-2 py-1 rounded"
        :class="$i18n.locale == 'he' ? 'bg-white' : 'bg-gray-200'"
      >
        <span class="px-1"> HE </span>
        <svg
    ...
    <nuxt-link :to="switchLocalePath('en')">
      <div
        class="flex px-2 py-1 rounded"
        :class="$i18n.locale == 'en' ? 'bg-white' : 'bg-gray-200'"
      >
