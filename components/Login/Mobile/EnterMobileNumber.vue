    ...
    <div v-if="!email" class="relative h-full">
      ...
      >
        ...
        <!-- <div class="px-12 mt-4 text-center">
          <span
            @click="email = !email"
            class="cursor-pointer text-primary-200 hover:text-primary-500"
          >
            Use Email Address
          </span>
        </div> -->
      ...
      <!-- <div class="flex flex-row justify-center px-4 py-10 sm:px-2 lg:py-8">
        <div class="rounded cursor-pointer me-4 hover:shadow-md">
          <svg
            width="154"
            height="43"
            viewBox="0 0 154 43"
        ...
        <div class="rounded cursor-pointer hover:shadow-md">
          <svg
            width="154"
            height="43"
            viewBox="0 0 154 43"
