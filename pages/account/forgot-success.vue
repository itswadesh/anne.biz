  ...
  >
    <div class="w-full max-w-sm mx-auto">
      <div class="p-2.5 md:p-0 frosted rounded-md shadow-md">
        ...
        <div class="py-10 mx-auto md:w-10/12">
          <nuxt-link to="/" class="">
            <span
              class="
                text-4xl
          ...
          <div>
            ...
            <div class="flex flex-col my-5 space-y-5">
              <div>
                ...
                <h5>{{ settings.websiteName }}</h5>
              </div>
              <h5>Password reset link sent to your email successfully</h5>
              <a href="https://mail.google.com" class="my-10 link">
